...
public:
	...
	struct FBasicParticleData                     CallFunc_Array_Get_Item;                           // 0x0098(0x0038)(NoDestructor)
...
static_assert(alignof(BP_FluxDataComponent_C_SetArrayData) == 0x000008, "Wrong alignment on BP_FluxDataComponent_C_SetArrayData");
static_assert(sizeof(BP_FluxDataComponent_C_SetArrayData) == 0x000188, "Wrong size on BP_FluxDataComponent_C_SetArrayData");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, ParticleDataStructure) == 0x000000, "Member 'BP_FluxDataComponent_C_SetArrayData::ParticleDataStructure' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, AverageScale) == 0x000010, "Member 'BP_FluxDataComponent_C_SetArrayData::AverageScale' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, Temp_int_Array_Index_Variable) == 0x000018, "Member 'BP_FluxDataComponent_C_SetArrayData::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_MakeVector_ReturnValue) == 0x000020, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, Temp_int_Loop_Counter_Variable) == 0x000038, "Member 'BP_FluxDataComponent_C_SetArrayData::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Add_IntInt_ReturnValue) == 0x00003C, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, Temp_int_Array_Index_Variable_1) == 0x000040, "Member 'BP_FluxDataComponent_C_SetArrayData::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_MakeVector_ReturnValue_1) == 0x000048, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_MakeVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Multiply_VectorVector_ReturnValue) == 0x000060, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Multiply_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000078, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x000080, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Array_Get_Item) == 0x000098, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Array_Length_ReturnValue) == 0x0000D0, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Add_VectorVector_ReturnValue) == 0x0000D8, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Add_VectorVector_ReturnValue_1) == 0x0000F0, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000108, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Array_Length_ReturnValue_1) == 0x000110, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000118, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000120, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, Temp_int_Loop_Counter_Variable_1) == 0x000128, "Member 'BP_FluxDataComponent_C_SetArrayData::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Less_IntInt_ReturnValue) == 0x00012C, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Add_IntInt_ReturnValue_1) == 0x000130, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Array_Get_Item_1) == 0x000138, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Array_Length_ReturnValue_2) == 0x000170, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Less_IntInt_ReturnValue_1) == 0x000174, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_Add_DoubleDouble_B_ImplicitCast) == 0x000178, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_Add_DoubleDouble_B_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_SetArrayData, CallFunc_DrawDebugSphere_Duration_ImplicitCast) == 0x000180, "Member 'BP_FluxDataComponent_C_SetArrayData::CallFunc_DrawDebugSphere_Duration_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(BP_FluxDataComponent_C_ApplyNiagaraParameters, CallFunc_FMax_ReturnValue) == 0x000000, "Member 'BP_FluxDataComponent_C_ApplyNiagaraParameters::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FluxDataComponent_C_ApplyNiagaraParameters, CallFunc_SetFloatParameter_Param_ImplicitCast) == 0x000008, "Member 'BP_FluxDataComponent_C_ApplyNiagaraParameters::CallFunc_SetFloatParameter_Param_ImplicitCast' has a wrong offset!");
