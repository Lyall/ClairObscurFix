...
struct ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_AnimGraph final
{
public:
	struct FPoseLink                              InPose;                                            // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
	struct FPoseLink                              AnimGraph_0;                                       // 0x0010(0x0010)(Parm, OutParm, NoDestructor)
};
static_assert(alignof(ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_AnimGraph) == 0x000008, "Wrong alignment on ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_AnimGraph");
...
static_assert(offsetof(ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_AnimGraph, InPose) == 0x000000, "Member 'ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_AnimGraph::InPose' has a wrong offset!");
static_assert(offsetof(ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_AnimGraph, AnimGraph_0) == 0x000010, "Member 'ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_AnimGraph::AnimGraph_0' has a wrong offset!");
...
struct ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_ExecuteUbergraph_ABP_PostProcess_HairVar_MAELLE_DoubleBraided final
{
public:
...
static_assert(alignof(ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_ExecuteUbergraph_ABP_PostProcess_HairVar_MAELLE_DoubleBraided) == 0x000004, "Wrong alignment on ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_ExecuteUbergraph_ABP_PostProcess_HairVar_MAELLE_DoubleBraided");
...
static_assert(offsetof(ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_ExecuteUbergraph_ABP_PostProcess_HairVar_MAELLE_DoubleBraided, EntryPoint) == 0x000000, "Member 'ABP_PostProcess_HairVar_MAELLE_DoubleBraided_C_ExecuteUbergraph_ABP_PostProcess_HairVar_MAELLE_DoubleBraided::EntryPoint' has a wrong offset!");
