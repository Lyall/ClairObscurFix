...
void IBPI_FluxSurface_C::SetColorPreset(int32 Index_0, class UPDA_FluxSurfacePreset_C* Preset)
{
	static class UFunction* Func = nullptr;
...
// Function BPI_FluxSurface.BPI_FluxSurface_C.OnGlassMeshChanged
// (Public, BlueprintCallable, BlueprintEvent)

void IBPI_FluxSurface_C::OnGlassMeshChanged()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_FluxSurface_C", "OnGlassMeshChanged");
...
void IBPI_FluxSurface_C::GetColorPreset(int32 Index_0, class UPDA_FluxSurfacePreset_C** Preset)
{
	static class UFunction* Func = nullptr;
